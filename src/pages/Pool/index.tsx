...
export default function Pool() {
  ...
  // fetch the user's balances of all tracked V2 LP tokens  取所有跟踪的V2 LP令牌的用户余额
  ...
  // fetch the reserves for all V2 pools in which the user has a balance 获取用户拥有余额的所有V2池的储备金
