...
export default function AddLiquidity({
  ...
  async function onAdd() {
    ...
    let value: BigNumber | null
      console.info("currencyA --> %s  currencyB --> %s ETHER --> %s",JSON.stringify(currencyA), JSON.stringify(currencyB),JSON.stringify(ETHER))
    ...
    // const aa = await estimate(...args, value ? { value } : {})
      console.info("args -->> %s   value --> %s",JSON.stringify(args),JSON.stringify(value))
      ...
      .then((estimatedGasLimit) =>
        method(...args, {
          ...
          setAttemptingTxn(false)
            console.info("setAttemptingTxn(false)")
